/**
 * Profile
 * @namespace project_api.profiles.services
 */
(function() {
  'use strict';

  angular
    .module('project_api.profiles.services')
  ...
  function Profile($http) {
     ...
     * @memberOf project_api.profiles.services.Profile
     */
    var Profile = {
      destroy: destroy,
      get: get,
     ...
     * @returns {Promise}
     * @memberOf project_api.profiles.services.Profiles
     */
